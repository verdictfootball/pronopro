...
const CACHE_NAME = 'pronopro-cache-v2';
...
self.addEventListener('fetch', (event) => {
  ...
  // Netwerk-eerst: haal altijd de nieuwste versie op zolang er internet is. De cache
  // dient uitsluitend als noodoplossing wanneer het netwerk niet bereikbaar is (offline),
  // zodat updates aan de site nooit "vastzitten" achter een oude, gecachte kopie.
  event.respondWith(
    fetch(event.request)
      .then((response) => {
